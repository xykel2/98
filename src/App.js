...
export default function App() {
  ...
  flexDirection: 'column',
          ...
          >
            ...
            <div style={{ fontFamily: 'Courier', padding: '1rem', fontSize: '16px', lineHeight: '1.5' }}>
              <p>Xinyu Kelly Yan is a self-proclaimed <a href="https://www.theguardian.com/cities/2016/jul/29/female-flaneur-women-reclaim-streets" target="_blank" rel="noopener noreferrer" className="underline text-blue-300 hover:text-blue-500">flaneuse</a> studying international planning with a BA in anthropology and urban studies. </p>
 ...
 <p> and this awesome mixtape of Providence experimental music <a href= "https://alter-diy.bandcamp.com/album/altercomp-ii-red-season" target="_blank" rel="noopener noreferrer" className="underline text-blue-300 hover:text-blue-500">
              ALTERCOMP II.</a> </p>
